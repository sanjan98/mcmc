...
# Imports
import mcmc.src.utils.mcmc_utils_and_plot as utils
import mcmc.src.main.mcmc as mc
import numpy as np
...
def main(target):
    ...
    if target=='gaussian':
        ...
        target_logpdf = lambda x: utils.lognormpdf(x, gauss_mean, gauss_cov)
    ...
    # DRAM sampler
    samples, ar = mc.dram(map, prop_cov, num_samples, target_logpdf, prop_logpdf, 
